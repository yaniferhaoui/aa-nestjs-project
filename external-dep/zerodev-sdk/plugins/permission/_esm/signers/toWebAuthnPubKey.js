...
export const toWebAuthnPubKey = async ({ passkeyName, passkeyServerUrl, mode = WebAuthnMode.Login }) => {
    let pubKey;
    ...
    if (mode === WebAuthnMode.Login) {
        ...
        authenticatorIdHash = keccak256(uint8ArrayToHexString(b64ToBytes(loginCred.id)));
        ...
        // get authenticatorIdHash
        authenticatorIdHash = keccak256(uint8ArrayToHexString(b64ToBytes(registerCred.id)));
        // Verify registration
