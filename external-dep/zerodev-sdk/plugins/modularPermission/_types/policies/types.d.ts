...
export type MerklePolicyParams<TAbi extends Abi | readonly unknown[], TFunctionName extends string | undefined = string> = PolicyParams & {
...
export type Policy<entryPoint extends EntryPoint> = {
    getPolicyData: () => Hex;
    getSignaturePolicyData: (userOperation: UserOperation<GetEntryPointVersion<entryPoint>>) => Hex;
    getPolicyInfoInBytes: () => Hex;
    policyParams: (SudoPolicyParams & {
        type: "sudo";
