...
exports.revokeSessionKey = void 0;
...
const revokeSessionKey = async (accountClient, sessionKeyAddress = "0x") => {
    return await accountClient.sendUserOperation({
        userOperation: {
            callData: await accountClient.account.encodeCallData({
                to: index_js_1.SESSION_KEY_VALIDATOR_ADDRESS,
                value: 0n,
...
//# sourceMappingURL=revokeSessionKey.js.map