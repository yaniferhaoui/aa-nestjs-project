...
import type { Index, Quantity, RpcBlock, RpcTransactionRequest as RpcTransactionRequest_, RpcTransaction as RpcTransaction_, TransactionType } from '../types/rpc.js';
import type { AccessList, TransactionBase, TransactionRequestBase, TransactionRequest as TransactionRequest_, TransactionSerializable, TransactionSerializableBase, TransactionSerialized, Transaction as Transaction_ } from '../types/transaction.js';
...
export type CeloTransactionSerializable = OneOf<TransactionSerializable | TransactionSerializableCIP42 | TransactionSerializableCIP64>;
export type CeloTransactionSerialized<TType extends CeloTransactionType = CeloTransactionType> = TransactionSerialized<TType> | TransactionSerializedCIP42 | TransactionSerializedCIP64;
...
export type RpcTransactionRequestCIP42 = TransactionRequestBase<Quantity, Index> & ExactPartial<FeeValuesEIP1559<Quantity>> & {
...
export type RpcTransactionRequestCIP64 = TransactionRequestBase<Quantity, Index> & ExactPartial<FeeValuesEIP1559<Quantity>> & {
    accessList?: AccessList | undefined;
    feeCurrency?: Address | undefined;
    gatewayFee?: undefined;
    gatewayFeeRecipient?: undefined;
...
export type TransactionRequestCIP42 = TransactionRequestBase & ExactPartial<FeeValuesEIP1559> & {
    accessList?: AccessList | undefined;
    feeCurrency?: Address | undefined;
    gatewayFee?: bigint | undefined;
    gatewayFeeRecipient?: Address | undefined;
...
export type TransactionRequestCIP64 = TransactionRequestBase & ExactPartial<FeeValuesEIP1559> & {
    accessList?: AccessList | undefined;
    feeCurrency?: Address | undefined;
    gatewayFee?: undefined;
    gatewayFeeRecipient?: undefined;
...
export type TransactionSerializableCIP42<TQuantity = bigint, TIndex = number> = TransactionSerializableBase<TQuantity, TIndex> & ExactPartial<FeeValuesEIP1559<TQuantity>> & {
    accessList?: AccessList | undefined;
    feeCurrency?: Address | undefined;
    gatewayFeeRecipient?: Address | undefined;
...
export type TransactionSerializableCIP64<TQuantity = bigint, TIndex = number> = TransactionSerializableBase<TQuantity, TIndex> & ExactPartial<FeeValuesEIP1559<TQuantity>> & {
    accessList?: AccessList | undefined;
    feeCurrency?: Address | undefined;
    gatewayFee?: undefined;
    gatewayFeeRecipient?: undefined;
